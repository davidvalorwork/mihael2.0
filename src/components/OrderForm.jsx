    ...
    <div className="mx-auto p-4">
      ...
      <form className="grid grid-cols-2 md:grid-cols-2 gap-4" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input type="text" id="zip" name="zip" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="90001" required />
